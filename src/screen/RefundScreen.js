    ...
    return <View style={styles.container}>
        ...
        <View style={{height:'7%' ,backgroundColor:Colors.pink}}>
          ...
          <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <Text numberOfLines={1} style={{marginStart:'2%',marginTop:'3%',fontFamily:'urbanistmedium',marginStart:'5%',fontSize:16,color:Colors.white}}>Refund Policy</Text>
            </View>
      ...
      <Text style={styles.heading}>Refund Policy for Wealthonomix Wealth Creators Private Limited Digital Courses</Text>
      
      <Text style={styles.heading}>1. Refund Eligibility</Text>
      ...
      <Text style={styles.heading}>2. Orientation Videos and Written Information</Text>
      <Text style={styles.paragraph}>
        Before making a purchase, we encourage users to take advantage of various assets course content and structure.
      </Text>

      <Text style={styles.heading}>3. Customer Support</Text>
      <Text style={styles.paragraph}>
        If you encounter any issues with your digital course, please reach out to our customer support team at support@wealthonomix.com for assistance. We are committed to resolving any technical or access issues promptly.
      </Text>
